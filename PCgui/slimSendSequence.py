# -*- coding: utf-8 -*-
"""
Created on Sun May 22 20:30:34 2022
...
def getCylon(frameNr):
    frameMod = frameNr % DISPLAY_NR_COLS
    text = ' ' * frameMod + 'I' + ' ' * (DISPLAY_NR_COLS - frameMod - 2)
    print(text)
    return text
